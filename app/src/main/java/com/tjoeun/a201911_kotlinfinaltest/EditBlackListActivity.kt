...
class EditBlackListActivity : BaseActivity() {
    ...
    override fun setupEvents() {
        postBtn.setOnClickListener {
            ...
            ServerUtil.postRequestBlackList(mContext, titleEdt.text.toString(), contentEdt.text.toString(),
                    ...
                    override fun onResponse(json: JSONObject) {
                        ...
                        runOnUiThread {
                            if(code == 200) {
                                ...
                                Toast.makeText(mContext, "게시글 등록에 실패했습니다. 관리자에게 문의하시기 바랍니다.", Toast.LENGTH_SHORT).show()
                            }
                        }
